...
public class VerificationRequestV1Test {
    ...
    public void jsonSerialization() {
        ...
        val request = VerificationRequestV1.builder()
                ...
                .build();
        val expected = "{\"context\":{\"given\":[{\"label\":\"Nonce\",\"context\":\"0101010101010101010101010101010101010101010101010101010101010101\"},{\"label\":\"ConnectionID\",\"context\":\"0102010201020102010201020102010201020102010201020102010201020102\"},{\"label\":\"ContextString\",\"context\":\"Wine payment\"}],\"requested\":[\"BlockHash\",\"ResourceID\"],\"type\":\"ConcordiumUnfilledContextInformationV1\"},\"subjectClaims\":[{\"type\":\"identity\",\"source\":[\"identityCredential\"],\"statements\":[{\"type\":\"RevealAttribute\",\"attributeTag\":\"firstName\"}],\"issuers\":[\"did:ccd:testnet:idp:0\",\"did:ccd:testnet:idp:1\",\"did:ccd:testnet:idp:2\"]}],\"transactionRef\":\"0102030401020304010203040102030401020304010203040102030401020304\",\"type\":\"ConcordiumVerificationRequestV1\"}";
        Assert.assertEquals(
                expected,
