...
public class ClientV2GetBakerRewardPeriodInfoTest {
    ...
    private static final com.concordium.sdk.responses.bakersrewardperiod.BakerRewardPeriodInfo CLIENT_INFO_1 =
            com.concordium.sdk.responses.bakersrewardperiod.BakerRewardPeriodInfo.builder()
                    ...
                    .commissionRates(CommissionRates.builder()
                            .finalizationCommission(PartsPerHundredThousand.from(COM_FINAL_1))
                            .bakingCommission(PartsPerHundredThousand.from(COM_BAKING_1))
                            .transactionCommission(PartsPerHundredThousand.from(COM_TRAN_1))
                            .build())
    ...
    private static final com.concordium.sdk.responses.bakersrewardperiod.BakerRewardPeriodInfo CLIENT_INFO_2 =
            com.concordium.sdk.responses.bakersrewardperiod.BakerRewardPeriodInfo.builder()
                    ...
                    .commissionRates(CommissionRates.builder()
                            .finalizationCommission(PartsPerHundredThousand.from(COM_FINAL_2))
                            .bakingCommission(PartsPerHundredThousand.from(COM_BAKING_2))
                            .transactionCommission(PartsPerHundredThousand.from(COM_TRAN_2))
                            .build())
