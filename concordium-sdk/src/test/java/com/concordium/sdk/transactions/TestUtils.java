...
public class TestUtils {
    ...
    static byte[] unsignedByteArrayToSigned(int[] bytes) {
    ...
    final static int[] EXPECTED_BLOCK_ITEM_TRANSFER_WITH_REGISTER_DATA_VERSIONED_BYTES = new int[]{0, 0, 1, 0, 2, 0, 0, 64, 39, 169, 162, 112, 163, 229, 60, 158, 30, 147, 102, 63, 215, 138, 43, 208, 100, 27, 13, 81, 75, 222, 106, 47, 246, 229, 230, 153, 167, 64, 34, 119, 86, 127, 34, 253, 105, 192, 89, 6, 186, 52, 236, 78, 222, 238, 21, 166, 241, 219, 162, 208, 126, 157, 76, 58, 218, 134, 179, 192, 148, 166, 37, 3, 1, 0, 64, 253, 110, 243, 125, 70, 211, 34, 99, 65, 43, 26, 22, 151, 129, 61, 0, 61, 233, 64, 49, 220, 91, 211, 201, 106, 97, 192, 217, 27, 95, 165, 25, 245, 114, 252, 252, 2, 87, 10, 210, 80, 80, 53, 48, 232, 150, 30, 123, 184, 195, 88, 105, 49, 32, 11, 63, 84, 246, 34, 197, 105, 222, 19, 13, 48, 29, 107, 23, 16, 181, 115, 90, 252, 36, 88, 152, 1, 33, 61, 19, 170, 107, 68, 120, 137, 15, 223, 232, 25, 91, 202, 14, 175, 34, 97, 78, 0, 0, 0, 0, 0, 1, 52, 62, 0, 0, 0, 0, 0, 0, 2, 56, 0, 0, 0, 8, 0, 0, 0, 0, 0, 1, 226, 64, 21, 0, 5, 1, 2, 3, 4, 5};
}
