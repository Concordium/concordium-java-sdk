...
public class EncryptedTransferWithMemoUtilTest {

    @SneakyThrows
    @Test
    public void testEncryptedTransferWithMemoUtil() {
        ...
        EncryptedTransferWithMemoTransaction transaction = TransactionFactory.newEncryptedTransferWithMemo(
                        y,
