...
public class UpdateContractTest {
    ...
    public void updateContractTest() {
        ...
        System.out.println(Arrays.toString(TestUtils.signedByteArrayToUnsigned(blockItemBytes)));
        ...
        System.out.println(Arrays.toString(TestUtils.signedByteArrayToUnsigned(blockItemVersionedBytes)));
