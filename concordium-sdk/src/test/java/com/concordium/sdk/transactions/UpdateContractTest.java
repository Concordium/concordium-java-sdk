...
public class UpdateContractTest {
    ...
    public void updateContractTest() {
        ...
        AccountTransaction tx = TransactionFactory.newUpdateContract()
        ...
        val transferDataToSign = AccountTransaction.getDataToSign(tx.getHeader(), payload);
