...
@JsonSerialize(using = CredentialAttributeTypeSerializer.class)
@JsonDeserialize(using = CredentialAttributieTypeDeserializer.class)
@Builder
@Getter
...
class CredentialAttributieTypeDeserializer extends JsonDeserializer<CredentialAttribute> {
...
class CredentialAttributeTypeSerializer extends JsonSerializer<CredentialAttribute> {
    @Override
