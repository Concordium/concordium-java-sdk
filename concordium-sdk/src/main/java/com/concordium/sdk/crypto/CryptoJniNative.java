...
import com.concordium.sdk.crypto.wallet.*;
...
public class CryptoJniNative {
     ...
     *
     * @param input {@link com.concordium.sdk.crypto.wallet.web3Id.Web3IdProofInput} serialized as JSON.
     * @return JSON representing {@link StringResult}. If successful the field 'result' contains the
     * {@link com.concordium.sdk.crypto.wallet.web3Id.Web3IdProof} as JSON.
     */
     ...
     *
     * @param input {@link QualifiedRequest} serialized as JSON.
     * @return JSON representing {@link StringResult}. If successful the field
     * 'result' is empty,
     ...
     *
     * @param input     {@link com.concordium.sdk.crypto.wallet.web3Id.Statement.AtomicStatement} serialized as JSON.
