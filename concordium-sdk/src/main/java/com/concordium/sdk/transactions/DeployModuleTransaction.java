...
public class DeployModuleTransaction extends AbstractTransaction {
    ...
    @Builder
    DeployModuleTransaction(AccountAddress sender, AccountNonce nonce, Expiry expiry, TransactionSigner signer, WasmModule module) throws TransactionCreationException {
        this.sender = sender;
        this.nonce = nonce;
        this.expiry = expiry;
        this.signer = signer;
    ...
    private static class CustomBuilder extends DeployModuleTransaction.DeployModuleTransactionBuilder {
        ...
        public DeployModuleTransaction build() throws TransactionCreationException {
            ...
            Transaction.verifyInput(transaction.sender, transaction.nonce, transaction.expiry, transaction.signer);
        ...
        private Payload createNewTransaction(DeployModuleTransaction transaction) throws TransactionCreationException {
            return DeployModule.createNew(transaction.getModule())
