...
public interface Transaction {
    ...
    static void verifyAccountTransactionHeaders(AccountAddress sender, AccountNonce nonce, Expiry expiry, TransactionSigner signer) throws TransactionCreationException {
