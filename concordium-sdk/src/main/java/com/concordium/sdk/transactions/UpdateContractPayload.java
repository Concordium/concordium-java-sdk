...
public final class UpdateContractPayload {
    ...
    public static UpdateContractPayload from(@NonNull final ContractAddress contractAddress,
        ...
        if (! (schemaParameter.getType() == ParameterType.RECEIVE)) {throw new IllegalArgumentException("SchemaParameter for UpdateContractPayload must be initialized with a ReceiveName");}
