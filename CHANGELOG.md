...
## Unreleased changes
- Added BlockItemStatus utilising BlockTransactionEvent as return type of `GetBlockItemStatus
...
- Added support for GRPC V2 `GetBlockTransactionEvents` for retrieving a list of events generated by a transaction.
